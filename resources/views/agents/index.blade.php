<x-app-layout>
    ...
    <div class="flex items-center justify-end w-full gap-4 py-2 my-2 action-tabs">
        ...
        <a href="{{ route('agent.create') }}" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700">
            Add Agent 
        </a>
    </div>
    ...
    <div class="w-full overflow-x-auto border rounded-lg shadow-sm content-wrapper">
        ...
        <table class="w-full text-sm text-left table-auto">
            ...
            <tbody id="agentsTableBody" class="text-gray-600 divide-y">
            </tbody>
        ...
        <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
            ...
            <div>
                <nav aria-label="Pagination" class="inline-flex -space-x-px rounded-md shadow-xs isolate">
                    ...
                    @else
                        <a href="{{ $agents->previousPageUrl() }}" class="relative inline-flex items-center px-2 py-2 text-gray-400 rounded-l-md inset-ring inset-ring-gray-300 hover:text-gray-700 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
                    ...
                    @foreach ($agents->getUrlRange(1, $agents->lastPage()) as $page => $url)
                        ...
                        <a href="{{ $url }}" {!! $page == $agents->currentPage()
                    ...
                    @if ( $agents->hasMorePages() )
                        <a href="{{ $agents->nextPageUrl() }}" class="relative inline-flex items-center px-2 py-2 text-gray-400 rounded-r-md inset-ring inset-ring-gray-300 hover:text-gray-700 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
...
<script>
    ...
    const agents = <?=  json_encode($agents->toArray()['data']); ?>;
    ...
    function renderAgents(limit) {
        ...
        agents.slice(0, limit).forEach(agent => {
            ...
            row.innerHTML = `
                ...
                <td class="px-6 py-3">${agent.created_at}</td>
            `;

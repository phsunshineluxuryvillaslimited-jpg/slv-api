                ...
                <dl class="space-y-3">
                    <div>
                        ...
                        <dd class="flex gap-3 group relative text-sm break-words text-slate-800">
                            <input type="text" name="email" id="email" data-field="email" data-id="{{ $agent->id }}" value="{{ $agent->email }}" class="text-sm p-1 border-white" disabled/>
                            <button
                                id="emailEditBtn"
                    ...
                    <div><dt class="text-xs text-slate-500">Mobile</dt>
                        <dd class="flex gap-3 group relative text-sm break-words text-slate-800">
                            <input type="text" name="mobile" id="mobile" data-field="mobile_number" data-id="{{ $agent->id }}" value="{{ $agent->mobile_number }}" class="text-sm p-1 border-white" disabled/>
                            <button
                                id="mobileEditBtn"
                                class="hidden rounded-xs text-sm bg-white p-1 shadow hover:bg-gray-100 group-hover:block"
                                title="Edit"
                    ...
                    <div><dt class="text-xs text-slate-500">{{ __('Contact owner') }}</dt>
                        <dd class="flex gap-3 group relative text-sm break-words text-slate-800">
                            <input type="text" name="phone_number" id="phone" data-field="phone_number" data-id="{{ $agent->id }}" value="{{ $agent->phone_number }}" class="text-sm p-1 border-white" disabled/>
                            <button
                                id="phoneEditBtn"
                                class="hidden rounded-xs text-sm bg-white p-1 shadow hover:bg-gray-100 group-hover:block"
                                title="Edit"

            ...
            <section>
                ...
                <div class="grid grid-cols-4 md:grid-cols-4 gap-5 mb-4">
                    <div>
                        ...
                        <input type="text" name="nationality" id="nationality" class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required placeholder="Enter client nationality" >
                    </div>
                    <div>
                ...
                <div class="grid grid-cols-4 md:grid-cols-4 gap-5 mb-4">
                    <div class="col-span-3">
                        ...
                        <input type="text" name="address" id="telephone" class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required placeholder="Enter client address">
                    </div>
                    <div>
                        <label for="zipcode" class="required-field block text-black text-sm mb-1">{{ __('Zip Code') }}</label>
                        <input type="text"  name="zipcode" id="zipcode" class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required placeholder="Enter client zip code number">
                    </div>
                </div>

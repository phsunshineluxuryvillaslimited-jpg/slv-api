...
new class extends Component
{
    ...
    public function generateDescription()
    {
        ...
        $this->dispatch('descriptionGenerated', ['description' => $this->description]);
    }
}
                ...
                <div class="w-full">
                    ...
                    <div class="w-full py-5">
                        ...
                        <div class="flex gap-5">
                            <div class="w-full">
                                <textarea wire:model.live="description" id="description" class="w-full h-96 text-sm border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="" required>
                                                ...
                                                tinymce.init({
                                                    ...
                                                    setup: (editor) => {
                                                        ...
                                                        editor.on('init', () => {
                                                            ...
                                                            console.log('Initial content set:', editor.getContent());
                                                        });

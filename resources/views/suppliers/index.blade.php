...
<script>
    ...
    const vendors = [
        ...
        { name: 'Bill Clipton', email: 'bill.clipton@samplemail.com', mobile: '4234524534634', contactOwner: 'Abby', primaryCompany: '5 Queens', lastStatus: '01/01/0001 00:00:00' },
        ...
        { name: 'Lorren Gadhi', email: 'loren@samplemail.com', mobile: '4234524534634', contactOwner: 'Hazel', primaryCompany: '3KM group', lastStatus: '01/01/0001 00:00:00' },
        { name: 'Alan Davis', email: 'alan@samplemail.com', mobile: '4234524534634', contactOwner: 'Jasmine', primaryCompany: 'A-House', lastStatus: '01/01/0001 00:00:00' },
        { name: 'Venson Pucher', email: 'venson@samplemail.com', mobile: '4234524534634', contactOwner: 'Abby', primaryCompany: '5 Queens', lastStatus: '01/01/0001 00:00:00' },
        { name: 'Ranny Boise', email: 'ranny@samplemail.com', mobile: '4234524534634', contactOwner: 'Hazel', primaryCompany: 'A&M Pittakas Developers', lastStatus: '01/01/0001 00:00:00' },
        { name: 'Mina Gonzales', email: 'mina@samplemail.com', mobile: '4234524534634', contactOwner: 'Yulya', primaryCompany: 'Develta Group', lastStatus: '01/01/0001 00:00:00' },
    ];
        ...
        vendors.slice(0, limit).forEach(vendor => {
            ...
            row.innerHTML = `
                <td class="flex px-6 py-3 people-identity">
                    <a class="flex items-center gap-3" href="{{ route('vendors-info') }}">

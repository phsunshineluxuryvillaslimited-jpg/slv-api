        ...
        <aside class="w-full lg:w-[320px] shrink-0 bg-white border-r border-slate-200">
            ...
            <div class="px-5 pt-5">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h1 class="text-xl font-semibold leading-tight text-slate-900">Bill Hannigan</h1>
                        <p class="text-sm text-slate-500">Vendor at 3KM group</p>
                        <a href="mailto:bill.hannigan@samplemail.com" class="text-sm text-blue-600 break-all hover:underline">bill.hannigan@samplemail.com</a>
                    </div>
                </div>
            ...
            <div class="px-5 py-4 mt-4 border-t border-slate-100">
                ...
                <dl class="space-y-3">
                    <div><dt class="text-xs text-slate-500">Email</dt><dd class="text-sm break-words text-slate-800">bill.hannigan@samplemail.com</dd></div>
                    ...
                    <div><dt class="text-xs text-slate-500">Primary company</dt><dd class="text-sm break-words text-slate-800">3KM group</dd></div>
                    <div><dt class="text-xs text-slate-500">Vendor status</dt><dd class="text-sm break-words text-slate-800">Active</dd></div>
            ...
            <div class="px-5 py-4 border-t border-slate-100">
                ...
                <p class="mt-2 text-xs leading-relaxed text-slate-500">Manage the communications this vendor receives from you.</p>
            </div>
        </aside>
            ...
            <section class="bg-white border rounded-lg border-slate-200">
                <div class="flex items-center justify-between px-4 py-3 border-b border-slate-100">
                    <h3 class="flex items-center gap-2 text-sm font-semibold text-slate-800">
                        <svg class="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L23 12l-5.714 2.143L15 21l-2.286-6.857L7 12l5.714-2.143L15 3z" /></svg>
                        Smart record summary
                    </h3>
                    <span class="text-[10px] font-semibold text-white bg-gradient-to-r from-blue-500 to-indigo-500 px-1.5 py-0.5 rounded">AI</span>
                </div>
                <div class="px-4 py-4">

            ...
            <section>
                ...
                <div class="grid grid-cols-2 md:grid-cols-2 gap-5 mb-4 mt-3">
                    <div>
                        ...
                        <input type="text" name="first_name" id="firstName" class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required placeholder="Enter vendor first name">
                    ...
                    <div>
                        ...
                        <input type="text" name="last_name" id="lastName" class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required placeholder="Enter vendor last name">
                ...
                <div class="grid grid-cols-3 md:grid-cols-3 gap-5 mb-4">
                    <div>
                        ...
                        <input type="email" name="email" id="email" class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required placeholder="Enter vendor email address" >
                    ...
                    <div>
                        ...
                        <input type="text" name="phone_number" id="telephone" class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required placeholder="Enter vendor telephone number">
                    </div>

                    <div>
                        <label for="mobile" class="required-field block text-black text-sm mb-1">{{ __('Mobile') }}</label>
                        <input type="text"  name="mobile_number" id="mobile" class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required placeholder="Enter vendor mobile number">
                    </div>
                </div>
